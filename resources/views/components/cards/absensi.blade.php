    ...
    <div class="card-body">
        <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col">
                <span class="text-2xl font-bold text-neutral-600 dark:text-white">{{ $title }}</span>
                @if ($text != '')
                    <span class="mt-1 text-md font-semibold text-neutral-900 dark:text-white">{{ $text }}</span>
                @else
