...
<div class="card {{ $bg_color['bg_base'] }} hover:shadow-lg transition duration-200 ease-in-out">
    <div class="card-body">
        <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col">
                <span class="text-sm font-medium text-neutral-600 dark:text-white">{{ $title }}</span>
                <span class="mt-1 text-2xl font-semibold text-neutral-900 dark:text-white">{{ $total }}</span>
            </div>
        </div>
    </div>
</div>
