    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div class="grid auto-rows-min gap-4 md:grid-cols-4">
            <x-cards.counter variant="danger" title="Total Absensi Saya" total="{{ $total_absensi_saya }}"
                icon="fas fa-user" />
            <x-cards.counter variant="info" title="Total Absensi" total="{{ $total_absensi }}" icon="fas fa-user-group" />
                ...
                <table
                    ...
                    <thead>
                        <tr class="bg-gray-100 dark:bg-neutral-800">
                            <th class="border border-neutral-200 dark:border-neutral-700 py-2 text-center max-w-[10px]">
                                #</th>
